...
!(function (a) {
  ...
  var c = function (c, d) {
    var e,
      ...
      I = function (a) {
        "y" === a && (a = "YYYY"),
          H({ type: "dp.update", change: a, viewDate: l.clone() });
      },
      J = function (a) {
        o &&
          (a && (i = Math.max(p, Math.min(3, i + a))),
          o
            .find(".datepicker > div")
            .hide()
      ...
      Q = function () {
        for (
          var b = [], c = l.clone().startOf("y").startOf("d");
          c.isSame(l, "y");
      ...
      S = function () {
        var a = o.find(".datepicker-years"),
          ...
          f = "";
        for (
          b.eq(0).find("span").attr("title", d.tooltips.nextDecade),
      ...
      T = function () {
        ...
        for (
          c.eq(0).find("span").attr("title", d.tooltips.prevCentury),
            ...
            a.find(".disabled").removeClass("disabled"),
            (e.isSame(b({ y: 1900 })) ||
              (d.minDate && d.minDate.isAfter(e, "y"))) &&
              c.eq(0).addClass("disabled"),
            c.eq(1).text(e.year() + "-" + f.year()),
            (e.isSame(b({ y: 2e3 })) ||
              (d.maxDate && d.maxDate.isBefore(f, "y"))) &&
      ...
      $ = function (a) {
        ...
        return a
          ...
          : ((m = !0),
            e.val(""),
            c.data("date", ""),
            H({ type: "dp.change", date: !1, oldDate: b }),
            void Z());
      },
      _ = function () {
        var b = !1;
      ...
      ba = {
        ...
        selectMonth: function (b) {
          ...
          l.month(c),
            i === p
              ? ($(k.clone().year(l.year()).month(l.month())), d.inline || _())
              : (J(-1), U()),
            I("M");
        },
        selectYear: function (b) {
          ...
          l.year(c),
            i === p
              ? ($(k.clone().year(l.year())), d.inline || _())
              : (J(-1), U()),
            I("YYYY");
        },
      ...
      ca = function (b) {
        return a(b.currentTarget).is(".disabled")
          ? !1
          : (ba[a(b.currentTarget).data("action")].apply(j, arguments), !1);
      },
      da = function () {
        var c,
          f = {
        ...
        return e.prop("disabled") ||
          ...
          o
          ? j
          : (void 0 !== e.val() && 0 !== e.val().trim().length
              ? $(fa(e.val().trim()))
              : d.useCurrent &&
                m &&
      ...
      na = function () {
        ...
        (g = a.replace(
          ...
          (f =
            g.toLowerCase().indexOf("a") < 1 &&
            g.replace(/\[.*?\]/g, "").indexOf("h") < 1),
          x("y") && (p = 2),
          x("M") && (p = 1),
          x("d") && (p = 0),
          (i = Math.max(p, i)),
    ...
    if (
      ...
      (j.defaultDate = function (a) {
        ...
        return (
          (d.defaultDate = c),
          ((d.defaultDate && d.inline) ||
            ("" === e.val().trim() && void 0 === e.attr("placeholder"))) &&
            $(d.defaultDate),
          j
        );
      }),
    ...
    return (
      ...
      e.is("input") && 0 !== e.val().trim().length
        ? $(fa(e.val().trim()))
        : d.defaultDate && void 0 === e.attr("placeholder") && $(d.defaultDate),
      d.inline && da(),
      j
    );
  };
      ...
      keyBinds: {
        up: function (a) {
          if (a) {
            ...
            a.find(".datepicker").is(":visible")
              ? this.date(c.clone().subtract(7, "d"))
              : this.date(c.clone().add(this.stepping(), "m"));
          }
        },
        down: function (a) {
          ...
          var c = this.date() || b();
          a.find(".datepicker").is(":visible")
            ? this.date(c.clone().add(7, "d"))
            : this.date(c.clone().subtract(this.stepping(), "m"));
        },
        "control up": function (a) {
          if (a) {
            var c = this.date() || b();
            a.find(".datepicker").is(":visible")
              ? this.date(c.clone().subtract(1, "y"))
              : this.date(c.clone().add(1, "h"));
          }
        },
        "control down": function (a) {
          if (a) {
            var c = this.date() || b();
            a.find(".datepicker").is(":visible")
              ? this.date(c.clone().add(1, "y"))
              : this.date(c.clone().subtract(1, "h"));
          }
        },
        left: function (a) {
          if (a) {
